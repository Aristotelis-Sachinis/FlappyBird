...
game_images = {}
framepersecond = 32
pipeimage = 'FlappyBird/images/pipe.png'
background_image = 'FlappyBird/images/background.jpg'
birdplayer_image = 'FlappyBird/images/bird.png'
sealevel_image = 'FlappyBird/images/base.jfif'
...
if __name__ == "__main__":
	...
	game_images['scoreimages'] = (
		pygame.image.load('FlappyBird/images/0.png').convert_alpha(),
		pygame.image.load('FlappyBird/images/1.png').convert_alpha(),
		pygame.image.load('FlappyBird/images/2.png').convert_alpha(),
		pygame.image.load('FlappyBird/images/3.png').convert_alpha(),
		pygame.image.load('FlappyBird/images/4.png').convert_alpha(),
		pygame.image.load('FlappyBird/images/5.png').convert_alpha(),
		pygame.image.load('FlappyBird/images/6.png').convert_alpha(),
		pygame.image.load('FlappyBird/images/7.png').convert_alpha(),
		pygame.image.load('FlappyBird/images/8.png').convert_alpha(),
		pygame.image.load('FlappyBird/images/9.png').convert_alpha()
	)
